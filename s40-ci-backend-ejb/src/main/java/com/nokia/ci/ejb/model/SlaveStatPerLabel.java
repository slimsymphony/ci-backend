 ...
 */
@Entity
@Table(name = "SLAVE_STAT_PER_LABEL")
public class SlaveStatPerLabel extends BaseEntity {
    ...
    public SlaveLabel getSlaveLabel() {
        return slaveLabel;
    }

    public void setSlaveLabel(SlaveLabel slaveLabel) {
