...
public class JenkinsVersion {
     ...
     */
    public boolean newerThan(JenkinsVersion other) {
     ...
     */
    public boolean olderThan(JenkinsVersion other) {
        return (compareTo(other) < 0);
    }
     ...
     */
    public int compareTo(JenkinsVersion other) {
        if (other == null) {
            return 1;
        }
    ...
    public boolean equals(Object other) {
        ...
        return this.compareTo((JenkinsVersion) other) == 0;
    }
